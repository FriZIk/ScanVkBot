    ...
    while(Index_Line!=Count_Lines-1):
        ...
        while(first_string_ips!=second_string_ips):
            ...
            try:
                ...
                s.close
                bot.send_message(message.chat.id,first_string_ips + ':' + str(Port) + ' Active port!!!Continue scanning ')
                white.write(first_string_ips + ':' + str(Port)+'\n')
